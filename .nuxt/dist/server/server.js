...
/******/ 			var chunk = require("./" + ({"1":"components/v-cards-list","2":"components/v-chart","3":"components/v-logo","4":"components/v-modal","5":"components/v-modal-error","6":"components/v-navigation","7":"components/v-select","8":"pages/favorite","9":"pages/index"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(7).default("08fe4348", content, true)
...
module.exports = __webpack_require__.p + "img/bg.165201f.png";
...
const actions = {
  async get({
    ...
    await this.$axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${payload.lat}&lon=${payload.lng}&appid=ca29067dffb0c20c387ccadffb76762e`).then(({
      data
    }) => {
...
__webpack_require__.d(components_namespaceObject, "VCardsList", function() { return VCardsList; });
__webpack_require__.d(components_namespaceObject, "VChart", function() { return VChart; });
__webpack_require__.d(components_namespaceObject, "VLogo", function() { return VLogo; });
__webpack_require__.d(components_namespaceObject, "VModal", function() { return VModal; });
__webpack_require__.d(components_namespaceObject, "VModalError", function() { return VModalError; });
__webpack_require__.d(components_namespaceObject, "VNavigation", function() { return VNavigation; });
...
const _04d3dbda = () => interopDefault(__webpack_require__.e(/* import() | pages/favorite */ 8).then(__webpack_require__.bind(null, 64)));
const _a56ffa2a = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 9).then(__webpack_require__.bind(null, 65)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(25), 'errorModal.js');
  resolveStoreModules(__webpack_require__(26), 'favorites.js');
  resolveStoreModules(__webpack_require__(27), 'modal.js');
  resolveStoreModules(__webpack_require__(28), 'weather.js');
...
const VCardsList = () => __webpack_require__.e(/* import() | components/v-cards-list */ 1).then(__webpack_require__.bind(null, 61)).then(c => wrapFunctional(c.default || c));
const VChart = () => __webpack_require__.e(/* import() | components/v-chart */ 2).then(__webpack_require__.bind(null, 34)).then(c => wrapFunctional(c.default || c));
const VLogo = () => __webpack_require__.e(/* import() | components/v-logo */ 3).then(__webpack_require__.bind(null, 42)).then(c => wrapFunctional(c.default || c));
const VModal = () => __webpack_require__.e(/* import() | components/v-modal */ 4).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c));
const VModalError = () => __webpack_require__.e(/* import() | components/v-modal-error */ 5).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const VNavigation = () => __webpack_require__.e(/* import() | components/v-navigation */ 6).then(__webpack_require__.bind(null, 41)).then(c => wrapFunctional(c.default || c));
const VSelect = () => __webpack_require__.e(/* import() | components/v-select */ 7).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c));
