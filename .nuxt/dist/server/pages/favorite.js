...
var add = __webpack_require__(7).default
module.exports.__inject__ = function (context) {
  add("7892f411", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/pug-plain-loader??ref--1-oneOf-0-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/VModal.vue?vue&type=template&id=b3a655aa&scoped=true&lang=pug&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"modal__wrapper\" data-v-b3a655aa></div><div class=\"modal__content\" data-v-b3a655aa><p class=\"modal__content-text\" data-v-b3a655aa>Are u sure about this ? </p><div class=\"modal__content-buttons\" data-v-b3a655aa><button class=\"modal__content-buttons\" data-v-b3a655aa>Yes</button><button class=\"modal__content-buttons\" data-v-b3a655aa>No</button></div><img" + _vm._ssrAttr("src", __webpack_require__(31)) + " alt=\"Close\" class=\"modal__content-close\" data-v-b3a655aa></div>")]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/VModal.vue?vue&type=template&id=b3a655aa&scoped=true&lang=pug&
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VModal_vue_vue_type_style_index_0_id_b3a655aa_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VModal_vue_vue_type_style_index_0_id_b3a655aa_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VModal_vue_vue_type_style_index_0_id_b3a655aa_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VModal_vue_vue_type_style_index_0_id_b3a655aa_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_VModal_vue_vue_type_style_index_0_id_b3a655aa_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".modal[data-v-b3a655aa]{background:rgba(4,4,4,.5);height:100vh;left:0;position:fixed;top:0;width:100%;width:100vw;z-index:4}.modal__wrapper[data-v-b3a655aa]{height:100vh}.modal__content[data-v-b3a655aa],.modal__wrapper[data-v-b3a655aa]{align-items:center;display:flex;justify-content:center}.modal__content[data-v-b3a655aa]{background-color:#fff;border-radius:20px;flex-direction:column;height:50vh;left:50%;position:absolute;top:50%;transform:translate(-50%,-50%);width:50vh;z-index:5}.modal__content-text[data-v-b3a655aa]{font-size:24px;font-weight:700}.modal__content-buttons[data-v-b3a655aa]{margin-top:10px}.modal__content-buttons>button[data-v-b3a655aa]{border:none;border-radius:15px;color:#fff;margin:20px;padding:10px 20px}.modal__content-buttons>button[data-v-b3a655aa]:first-child{background-color:green}.modal__content-buttons>button[data-v-b3a655aa]:last-child{background-color:red}.modal__content-close[data-v-b3a655aa]{height:40px;position:absolute;right:0;top:0;transform:rotate(45deg);width:40px;z-index:4}.hide[data-v-b3a655aa]{display:none}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
var add = __webpack_require__(7).default
module.exports.__inject__ = function (context) {
  add("297fa4ef", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorite_vue_vue_type_style_index_0_id_3a345cb7_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorite_vue_vue_type_style_index_0_id_3a345cb7_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorite_vue_vue_type_style_index_0_id_3a345cb7_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorite_vue_vue_type_style_index_0_id_3a345cb7_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorite_vue_vue_type_style_index_0_id_3a345cb7_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".favorite[data-v-3a345cb7]{font-weight:700;max-height:400px}.favorite__cards[data-v-3a345cb7]{display:flex;flex-direction:column;margin-top:20px;overflow-y:scroll;width:100%}@media screen and (min-width:1200px){.favorite__cards[data-v-3a345cb7]{max-height:500px}}.favorite__cards-item[data-v-3a345cb7]{align-items:center;display:flex;flex-direction:column;margin-bottom:16px;width:100%}.card[data-v-3a345cb7]{background-color:#fff;border-radius:20px;padding:10px;position:relative;width:80%}@media screen and (min-width:900px){.card[data-v-3a345cb7]{width:50%}}.card__button-close[data-v-3a345cb7]{cursor:pointer;height:32px;position:absolute;right:0;top:0;transform:rotate(45deg);width:32px}.hideButton[data-v-3a345cb7]{display:none}.favorite[data-v-3a345cb7]{display:block}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/pug-plain-loader??ref--1-oneOf-0-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/favorite.vue?vue&type=template&id=3a345cb7&scoped=true&lang=pug&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "favorite"
  }, [_vm._ssrNode("<div class=\"container\" data-v-3a345cb7>", "</div>", [_c('VLogo'), _c('VNavigation'), _vm._l(_vm.list, function (favorite, idx) {
    return _vm._ssrNode("<ul class=\"favorite__cards\" data-v-3a345cb7>", "</ul>", [_vm._ssrNode("<li class=\"favorite__cards-item\" data-v-3a345cb7>", "</li>", [_vm._ssrNode("<div" + _vm._ssrClass("card", {
      'hideButton': _vm.isHide
    }) + " data-v-3a345cb7>", "</div>", [_vm._ssrNode("<img" + _vm._ssrAttr("src", __webpack_require__(31)) + " alt=\"Close\" class=\"card__button-close\" data-v-3a345cb7><p class=\"card__title\" data-v-3a345cb7>" + _vm._ssrEscape("City: " + _vm._s(favorite.name)) + "</p><p class=\"card__temp\" data-v-3a345cb7>" + _vm._ssrEscape("Temp: " + _vm._s(favorite.main.temp) + " K") + "</p><p class=\"card__feels\" data-v-3a345cb7>" + _vm._ssrEscape("Feels like: " + _vm._s(favorite.main.feels_like) + " K") + "</p>"), _c('VChart'), _vm.isFull ? _c('VModalError') : _c('pre'), _c('VModal')], 2)])]);
  })], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/favorite.vue?vue&type=template&id=3a345cb7&scoped=true&lang=pug&
